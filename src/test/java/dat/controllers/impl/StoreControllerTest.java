...
//    private static final EntityManagerFactory emf = HibernateConfig.getEntityManagerFactoryForTest(); // Brug test-EMF
...
//        LOGGER.info("API server started for testing.");
//    }
//
//    @BeforeEach
//    void setUp() {
//        if (emf == null || !emf.isOpen()) {
//            throw new IllegalStateException("EntityManagerFactory is closed before running test.");
//        }
//
//        // Populér brugere og generér tokens
...
//        if (emf != null && emf.isOpen()) {
//            emf.close();
//            LOGGER.info("EntityManagerFactory closed after all tests.");
//        }
//    }
//
//
